...
public class JdbcDemo10Operation {
    ...
    public void addProduct(int id,String name, String category, double price) {
        Statement stmt=null;
        String query ="inset into product_data(Product_Id,Product_Name,Product_Category,Product_Price)values("+id+",'"+name+"','"+category+"',"+price+")";
        try {
